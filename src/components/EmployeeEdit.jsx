...
export default function EmployeeEdit() {
  ...
  useEffect(() => {
    const fetchEmployee = async () => {
      ...
      setFormData({
        ...
        mobileNo: result.f_MobileNo,
        designation: result.f_Designation,
        gender: result.f_Gender,
        course: result.f_Course,
        pic: result.f_Image,
        createDate: result.f_CreateDate,
      });
    };
    fetchEmployee();
  }, [id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        errorElement.classList.remove("hidden");
        errorElement.innerHTML = "Form updated successfully!";
